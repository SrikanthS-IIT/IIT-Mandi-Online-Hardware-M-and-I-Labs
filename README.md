...
*Wind tunnel setup: The wind tunnel setup consist of a fan (5V DC), a 80 mm PMMA tube of 500 mm length, streamline rectifiers and two hollow tubes to connect the differentila pressure sensor to measure stagnation and static pressure. The differential pressure sensor is introduced in Lab 7.*

...
*Wind tunnel setup: Thhe wind tunnel setup consist of a fan (5V DC), a 80 mm PMMA tube of 500 mm length, streamline rectifieres and two tube to measure stagnation and static pressure. The two tube are connected to the differential pressure sensor introduced in Lab 7.*
